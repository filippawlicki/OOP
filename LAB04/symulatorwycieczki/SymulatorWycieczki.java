...
public class SymulatorWycieczki {
    ...
    public void setListaSluchaczy(Set<SluchaczPostepow> listaSluchaczy){
        this.listaSluchaczy = listaSluchaczy;
    }
    ...
    public void symuluj() {
        ...
        for(pozycjaGrupy = 0; pozycjaGrupy < wycieczka.getLiczbaElementowWycieczki(); pozycjaGrupy++) {
            ...
            for(SluchaczPostepow w : listaSluchaczy){
                w.aktualizujPostep(wycieczka.getElementWycieczki(pozycjaGrupy), pozycjaGrupy+1, wycieczka.getLiczbaElementowWycieczki());
            }
            ...
            if(elementWycieczki instanceof Wedrowka) {
                ...
                System.out.printf("Grupa porusza się z prędkością %.2f GOT/h\n", predkoscGrupy);
                ...
                System.out.println("Grupa doszla do atrakcji: "+atrakcja.getNazwa());

                for(Uczestnik u : grupa.getUczestnicy()){
                    u.reagujNaAtrakcje(atrakcja, czasWycieczki);
                }

                System.out.println("Atrakcja zajęła grupie "+atrakcja.getCzasZwiedzaniaAtrakcji()+" h");
                czasWycieczki += atrakcja.getCzasZwiedzaniaAtrakcji();
            }
